...
if __name__ == "__main__":
    bot = NerdLM('./nerdlm_app/model/datasets/trained_english_extended_qa.txt', training=True, inference=False, saved_model_name='nerdlm_app/nerdlm.pt') # Paste any random dataset path
